...
export default function Header() {
    ...
    const isActiveLink = (path) => location.pathname === path;  // Function to check active link

    return (
        <div className='h-[125px] flex justify-between pt-[4px] px-[40px] fixed z-50 top-0 w-full bg-white max-sm:px-4 shadow-[0_2px_33px_0px_rgba(0,0,0,0.8)]'>
