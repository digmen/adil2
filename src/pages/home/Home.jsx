    ...
    return (
        <div>
            ...
            <div className='flex flex-col justify-center items-center'>
                ...
                <Link className='mt-[52px] bg-[#828282] px-[70px] py-[7px] rounded-[67px] text-white text-[30px] font-medium max-sm:text-[20px]' to='/product'>More Product</Link>
            </div>
            ...
            <div className='flex justify-between mx-[125px] mt-[114px] lg:mx-[100px] md:mx-[40px] max-sm:mx-[10px] max-sm:flex-wrap max-sm:justify-center'>
                <div className='w-[571px] flex flex-col'>
                    ...
                    <div className='mt-[50px] max-sm:flex max-sm:justify-center'>
                        <Link className='max-sm:text-[20px] max-sm:mt-0 max-sm:mb-[20px] mt-[52px] bg-[#828282] px-[70px] py-[7px] rounded-[67px] text-white text-[30px] font-medium' to='/about'>Find Out More</Link>
                    </div>
                </div>
            ...
            <div className='h-[605px] relative mt-[40px]' style={{ backgroundImage: `url(${homeImageTwo})`, backgroundRepeat: 'repeat', width: '100%', backgroundSize: 'cover' }}>
                ...
                <div className='h-[605px] flex flex-col items-center justify-center z-20'>
                    ...
                    <Link className='max-sm:text-[20px] mt-[52px] bg-[#828282] px-[84px] py-[7px] rounded-[67px] text-white text-[30px] font-medium  z-20' to='/contact'>Contact Us</Link>
                </div>
            </div>
        </div>
    )
