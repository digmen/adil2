    ...
    return (
        <div>
            ...
            <div className='flex flex-col justify-center items-center'>
                ...
                <Link className='mt-[52px] bg-[#828282] px-[70px] py-[7px] rounded-[67px] text-white text-[30px] font-medium max-sm:text-[20px]' to='/product'>{t('home.btn1')}</Link>
            </div>
            ...
            <div className='flex justify-between mx-[125px] mt-[114px] lg:mx-[100px] md:mx-[40px] max-sm:mx-[10px] max-sm:flex-wrap max-sm:justify-center'>
                <div className='w-[571px] flex flex-col'>
                    <div className='flex flex-col gap-[20px]'>
                        <h1 className='text-[30px] text-white'>{t('home.titleAboutUs')}</h1>
                        <span className='text-[30px] text-white md:text-[20px] max-sm:text-[16px]'>{t('home.titleAboutUsPrgf')}</span>
                    </div>
                    <div className='mt-[30px]'>
                        <ol>
                            <li className='flex gap-2 items-center text-white max-sm:text-[16px]'><div className='w-[12px] h-[12px] bg-white rounded-full'></div>{t('home.titleAboutUsList1')}</li>
                            <li className='flex gap-2 items-center text-white max-sm:text-[16px]'><div className='w-[12px] h-[12px] bg-white rounded-full'></div>{t('home.titleAboutUsList2')}</li>
                            <li className='flex gap-2 items-center text-white max-sm:text-[16px]'><div className='w-[12px] h-[12px] bg-white rounded-full'></div>{t('home.titleAboutUsList3')}</li>
                        </ol>
                    </div>
                    <div className='mt-[50px] max-sm:flex max-sm:justify-center'>
                        <Link className='max-sm:text-[20px] max-sm:mt-0 max-sm:mb-[20px] mt-[52px] bg-[#828282] px-[70px] py-[7px] rounded-[67px] text-white text-[30px] font-medium' to='/about'>{t('home.btn2')}</Link>
                    </div>
                </div>
            ...
            <div className='h-[605px] relative mt-[40px]' style={{ backgroundImage: `url(${homeImageTwo})`, backgroundRepeat: 'repeat', width: '100%', backgroundSize: 'cover' }}>
                ...
                <div className='h-[605px] flex flex-col items-center justify-center z-20'>
                    <h1 className='text-[65px] font-extrabold text-white z-20 max-sm:text-[20px]'>{t('home.homeTitleDown')}</h1>
                    <span className='text-white text-[34px] font-semibold text-center w-[614px] mt-[108px] z-20 max-sm:text-[16px] max-sm:w-[330px]'>{t('home.homeTitleTextDown')}</span>
                    <Link className='max-sm:text-[20px] mt-[52px] bg-[#828282] px-[84px] py-[7px] rounded-[67px] text-white text-[30px] font-medium  z-20' to='/contact'>{t('home.btn3')}</Link>
                </div>
            </div>
        </div>
    )
