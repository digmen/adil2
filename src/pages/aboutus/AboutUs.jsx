  ...
  return (
    <>
      <div className='mt-[125px] max-sm:mt-[60px] max-lg:mt-[80px]'>
        ...
        <div className='px-[40px] mt-[40px] max-sm:mt-[20px] max-sm:px-4'>
          <div className='flex justify-between items-center gap-4 max-md:flex-col'>
            <div className='w-[636px] md:w-[350px] max-md:w-full'>
              <h1 className='text-[32px] max-sm:text-[24px] font-bold md:text-[24px] max-md:text-[20px]'>{t('about.ourMission.title')}</h1>
        ...
        <div className='px-[40px] mt-[100px]  max-sm:mt-[40px] max-sm:px-4'>
          <div className='flex flex-row-reverse items-center gap-4 justify-between max-md:flex-col'>
            <div className='w-[636px] md:w-[400px] max-md:w-full'>
              <h1 className='text-[32px] max-sm:text-[24px] font-bold md:text-[24px] max-md:text-[20px]'>{t('about.ourPhilosophy.title')}</h1>
        ...
        <div className='mt-[60px] px-[40px] flex flex-col max-sm:px-4'>
          <div className='flex justify-center'>
            <h1 className='text-[32px] max-sm:text-[24px] font-bold'>{t('about.ourValues.title')}</h1>
          </div>
          <div className='mt-[30px] flex flex-wrap justify-center gap-[30px]'>
            <div className='w-[350px] h-[253px] bg-[#CBCBCB] rounded-[25px] flex items-start'>
              <div className='p-[25px] flex flex-col gap-[10px]'>
                <h1 className='font-bold text-[26px] max-sm:text-[24px]'>{t('about.ourValues.dynamism.title')}</h1>
                <span className='font-light text-[16px]'>{t('about.ourValues.dynamism.description')}</span>
              </div>
            </div>
            <div className='w-[350px] h-[253px] bg-[#CBCBCB] rounded-[25px] flex items-start'>
              <div className='p-[25px] flex flex-col gap-[10px]'>
                <h1 className='font-bold text-[26px] max-sm:text-[24px]'>{t('about.ourValues.innovation.title')}</h1>
                <span className='font-light text-[16px]'>{t('about.ourValues.innovation.description')}</span>
              </div>
            </div>
            <div className='w-[350px] h-[253px] bg-[#CBCBCB] rounded-[25px] flex items-start'>
              <div className='p-[25px] flex flex-col gap-[10px]'>
                <h1 className='font-bold text-[26px] max-sm:text-[24px]'>{t('about.ourValues.passionForEcommerce.title')}</h1>
        ...
        <div className='px-[40px] mt-[100px] max-sm:mt-[40px] bg-[#FFCE33] max-sm:px-4'>
          <div className='flex justify-between items-center gap-3 max-sm:py-[20px] py-[50px] max-md:flex-col '>
            <div className='w-[600px] md:w-[400px] flex flex-col gap-[20px] max-md:w-full'>
              <h1 className='text-[32px] font-bold md:text-[24px] max-md:text-[20px] max-sm:text-[24px]'>{t('about.ourStory.title')}</h1>
