    ...
    <div>
      ...
      <div className='flex justify-center items-center my-[50px]'>
        <div className='flex flex-col items-center w-[950px] max-sm:w-[330px]'>
          <h1 className='text-white text-[45px] font-extrabold max-sm:text-[30px] text-center'>{t('contact.text1')}</h1>
          ...
          <div className='flex flex-col items-center mt-[30px]'>
            <h1 className='text-white text-[45px] font-extrabold max-sm:text-[30px]'>{t('contact.text2')}</h1>
            <span className='text-white text-[30px] font-medium max-sm:text-[20px]'>+90 212 345 67 89</span>
          </div>
          <div className='flex flex-col items-center mt-[30px]'>
            <h1 className='text-white text-[45px] font-extrabold max-sm:text-[30px]'>{t('contact.text3')}</h1>
