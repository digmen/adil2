    ...
    <>
      <div className='mt-[125px] max-sm:mt-[100px]'>
        ...
        <div className='px-[40px] max-sm:px-4'>
          <div className='flex justify-between max-sm:flex-col sm:flex-col max-sm:gap-5 sm:gap-4 lg:gap-[40px] lg:items-center py-[50px]'>
            <div className='w-[670px] lg:w-[470px] max-sm:w-[240px] flex flex-col gap-[20px]'>
              <h1 className='text-[32px] max-sm:text-[18px] font-bold'>{t('service.whyServiceBest.title')}</h1>
            ...
            <div className='w-[597px] h-[448px] max-sm:w-full  max-sm:h-[200px] sm:w-full lg:h-[440px]'>
              <img className='w-[597px] h-[448px] max-sm:w-full max-sm:h-[200px] sm:w-full lg:h-[440px]' src={serviceImg} alt='about img' />
            </div>
          </div>
        </div>

        <div className='mt-[60px] mb-[50px] px-[40px] max-sm:px-4 flex flex-col'>
